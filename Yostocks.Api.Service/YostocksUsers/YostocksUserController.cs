...
namespace Yostocks.Api.Service.YostocksUser
{
   
    [Authorize]
    public class YostocksUserController : ApiController
    {


        private ICompanyStockRepository _stockRepository;
        private IYostocksUserRepository _yostocksUserRepository;
        private IFragmentRepository _fragmentRepository;

        //CONSTRUCTOR
        public YostocksUserController(ICompanyStockRepository stockRepository,
